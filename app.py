...
if _q_lat is not None and _q_lon is not None:
    try:
        ...
        loc = None
st.markdown("<p class='section-subtitle' style='margin-top: 1rem;'>📍 Or use your live device location(GPS might not be accurate due to signal blocking.):</p>", unsafe_allow_html=True)
